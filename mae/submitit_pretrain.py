...
import main_pretrain_ours as trainer
import submitit
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/jmain02/home/J2AD007/txk47/cxz00-txk47/cliport").is_dir():
        p = Path(f"/jmain02/home/J2AD007/txk47/cxz00-txk47/cliport/output")
