...
DATASET_NAMES = 'vima_converted_externally_to_rlds:0.0.1'
DOWNLOAD_DIR = '/media/robot/New Volume/datasets/tensorflow_datasets'
print(f"Downloading {len(DATASET_NAMES)} datasets to {DOWNLOAD_DIR}.")
#for dataset_name in tqdm.tqdm(DATASET_NAMES):
tfds.load(DATASET_NAMES, data_dir=DOWNLOAD_DIR)
