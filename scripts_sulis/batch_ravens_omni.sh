...
exps_name="exps_cliport/0426_mpi_omni"
...
#                          train.data_dir="/home/a/acw694/CLIPort_new_loss/data_ours"
...
tasks=("packing-omni-objects"\
    "packing-omni-objects-inter"\
    "packing-omni-objects-intra"\
    "packing-omni-objects-group-inter"\
    "packing-omni-objects-group-intra"\
    "packing-omni-objects-group")


for task in "${tasks[@]}"
do
    echo "Running evaluation for agent: $agent_name with task: $task"
