...
wget -r -np -nH --cut-dirs=4 -R "index.html*" -P /data/home/acw694/CLIPort_new_loss/scratch https://rail.eecs.berkeley.edu/datasets/bridge_release/data/tfds/bridge_dataset/
