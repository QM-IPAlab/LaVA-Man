...
LANG_TASKS='assembling-kits-seq-seen-colors assembling-kits-seq-unseen-colors packing-boxes-pairs-seen-colors packing-boxes-pairs-unseen-colors stack-block-pyramid-seq-seen-colors stack-block-pyramid-seq-unseen-colors towers-of-hanoi-seq-seen-colors towers-of-hanoi-seq-unseen-colors'
