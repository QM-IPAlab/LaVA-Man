...
#SBATCH --gres=gpu:1
#SBATCH --job-name=project_finetune
...
exps_name="exps_all_projector_finetune"
...
python -m cliport.train  train.task=${task_name}\
                         ...
                         mae_model=mae_robot_projector\
                         train.accumulate_grad_batches=1 \
                         train.linear_probe=False \
                         pretrain_path=/jmain02/home/J2AD007/txk47/cxz00-txk47/cliport/output_mae_robot_lang_projector/checkpoint-160.pth
